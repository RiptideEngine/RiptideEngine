...
#define ROOT_SIGNATURE \
	"RootFlags(0)," \
	"RootConstants(b0, space = 0, num32BitConstants = 4)," \
	"DescriptorTable(SRV(t0, space = 0), UAV(u0, space = 0, numDescriptors = 4))," \
	"StaticSampler(s0, space = 0, filter = FILTER_MIN_MAG_MIP_LINEAR, addressU = TEXTURE_ADDRESS_CLAMP, addressV = TEXTURE_ADDRESS_CLAMP, addressW = TEXTURE_ADDRESS_CLAMP),"
