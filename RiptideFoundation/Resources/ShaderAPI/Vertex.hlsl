...
#define RIPTIDE_VERTEXBUFFER_SPACE                      33
...
#define RIPTILE_DECLARE_VERTEX_BUFFER(type, channel)    StructuredBuffer<type> GET_VERTEXBUFFER_NAME(channel) : register(COMBINE_2_TOKENS(t, channel), COMBINE_2_TOKENS(space, RIPTIDE_VERTEXBUFFER_SPACE))
